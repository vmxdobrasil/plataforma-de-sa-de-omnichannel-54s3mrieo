...
export function EditCompanyForm({ company, onSuccess }: { company: any; onSuccess: () => void }) {
  ...
  const [companyStatus, setCompanyStatus] = useState(company.company_status || 'active')
  const [creditLimitType, setCreditLimitType] = useState(company.credit_limit_type || 'fixed')
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Input name="rh_contact_name" defaultValue={company.rh_contact_name} />
            </div>
            <div className="space-y-2">
              <Label>Contato RH - Telefone</Label>
              <Input name="rh_contact_phone" defaultValue={company.rh_contact_phone} />
            </div>
            <div className="space-y-2">
              <Label>Contato RH - Email</Label>
              <Input type="email" name="rh_contact_email" defaultValue={company.rh_contact_email} />
            </div>
            <div className="space-y-2">
              <Label>Contato Financeiro - Nome</Label>
              <Input name="finance_contact_name" defaultValue={company.finance_contact_name} />
            </div>
            <div className="space-y-2">
              <Label>Contato Financeiro - Telefone</Label>
              <Input name="finance_contact_phone" defaultValue={company.finance_contact_phone} />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                defaultValue={company.finance_contact_email}
              />
            </div>
          </div>
        </div>
